...
# Add email-agent/ (2 levels up from main-agent/src) to
...
from shared.observability.tracing import (  # noqa: E402
    init_tracing,
    instrument_fastapi,
    instrument_httpx,
)
...
__all__ = ["setup_tracing", "instrument_fastapi", "instrument_httpx"]
