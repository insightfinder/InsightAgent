...
```bash
curl -fsSLO https://github.com/insightfinder/InsightAgent/raw/master/elasticsearch2/elasticsearch2.tar.gz
...
* `query_page_size`: The maximum messages number of each query, default is 1000
