## Use this script to deploy Rizhiyi Agent on multiple Hosts
# InsightAgent: Rizhiyi
Agent Type: rizhiyi
...
- Give a project name, select Project Type as "Log" and Agent Type as "td-agent".
...
##Vars for Rizhiyi
rizhiyiUrl=http://yottaapi-test:8190
rizhiyiAccessKey=
rizhiyiSecureKey=
rizhiyiSourceGroup=all
```
...
### Uninstallation:
Note: Uninstallation is required before you can install any other agent(e.g. cgroup) or you want to reinstall the current collectd agent.
