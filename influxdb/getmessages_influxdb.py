...
def start_data_processing():
    ...
    logger.debug('history range sql config: {}'.format(agent_config_vars['sql_config']))
...
def query_messages_influxdb(client, sql_str):
    try:
...
def get_agent_config_vars():
    ...
    if os.path.exists(config_ini):
        ...
        try:
            ...
            target_timestamp_timezone = config_parser.get('influxdb', 'target_timestamp_timezone', raw=True) or 'UTC'
            timestamp_format = config_parser.get('influxdb', 'timestamp_format', raw=True)
            timezone = config_parser.get('influxdb', 'timezone') or 'UTC'
