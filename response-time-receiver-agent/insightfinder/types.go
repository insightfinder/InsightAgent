...
// Service represents the InsightFinder service client
type Service struct {
...
// MetricDataPoint represents a single metric data point in InsightFinder format
...
// DataInTimestamp represents metrics at a specific timestamp
type DataInTimestamp struct {
	TimeStamp        int64              `json:"t"`
	MetricDataPoints *[]MetricDataPoint `json:"metricDataPointSet"`
}

// InstanceData represents data for a single instance
...
// MetricDataReceivePayload represents the payload for metric data API
...
// IFMetricPostRequestPayload represents the complete request to InsightFinder
...
// CheckAndAddCustomProjectRequest represents project creation request
...
// CheckAndAddCustomProjectResponse represents project check/creation response
