...
###### Installation Steps:
1. Download the osmosys.tar.gz package
...
###### Agent configuration:
The config.ini file contains all of the configuration settings needed to connect to the osmosys and to stream the data to Insightfinder cluster.
...
This will connect to the osmosys, but it will not send any data to Insightfinder cluster. This allows you to verify that you are getting data from Insightfinder edge cluster and that there are no failing exceptions in the agent configuration.
