...
#    if [[ -d "$DIRECTORY" -a ! -f ${PATH_TO_CONFIG_INI} ]]; then
		...
		echo "name_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "data_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "yarn_nodes=" >> ${PATH_TO_CONFIG_INI}
    ...
    if [ -d "$DIRECTORY" -a ! -f $PATH_TO_CONFIG_INI ]; then
        ...
        echo "[elasticsearch]" >> ${PATH_TO_CONFIG_INI}
		echo "elastic_search_nodes =" >> ${PATH_TO_CONFIG_INI}
   ...
   if [ -d "$DIRECTORY" -a ! -f $PATH_TO_CONFIG_INI ]; then
		touch ${PATH_TO_CONFIG_INI}
		echo "[hbase]" >> ${PATH_TO_CONFIG_INI}
		echo "name_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "data_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "yarn_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "master_nodes=" >> ${PATH_TO_CONFIG_INI}
		echo "region_servers=" >> ${PATH_TO_CONFIG_INI}

        add_insightfinder_details ${PATH_TO_CONFIG_INI}
   else
        echo "config.ini exists or directory doesnt exist..."
   fi
elif [ "$AGENT_TYPE" == "metricFileReplay" ] || [ "$AGENT_TYPE" ==  "logFileReplay" ]; then
    ...
    if [ -d $INSIGHTAGENTDIR -a ! -f ${PATH_TO_CONFIG_INI} ]; then
        ...
        echo "sampling_interval=${SAMPLING_INTERVAL}" >> ${PATH_TO_CONFIG_INI}
        echo "selected_fields=" >> ${PATH_TO_CONFIG_INI}
