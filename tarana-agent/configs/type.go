...
type Config struct {
	...
	Tarana        TaranaConfig        `yaml:"tarana"`
...
type TaranaConfig struct {
	BaseURL               string            `yaml:"base_url"`
	Username              string            `yaml:"username"`
	Password              string            `yaml:"password"`
	RegionIDs             []int             `yaml:"region_ids"`
	KPIs                  map[string]string `yaml:"kpis"` // KPI path to metric name mapping
...
// Authentication state for Tarana API
