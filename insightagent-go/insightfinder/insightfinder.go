...
// InsightFinderConfig is a struct that holds the configuration for "insightfinder"
...
func GetConfigBool(p *configparser.ConfigParser, section string, param string, required bool, defVal bool) bool {
	defer func() {
		if r := recover(); r != nil {
...
func GetConfigInt(p *configparser.ConfigParser, section string, param string, required bool, defVal int) int {
	defer func() {
		if r := recover(); r != nil {
			panic(fmt.Sprintf("Error reading config [%s][%s]: %v", section, param, r))
		}
...
func GetConfigString(p *configparser.ConfigParser, section string, param string, required bool) string {
	defer func() {
		if r := recover(); r != nil {
			panic(fmt.Sprintf("Error reading config [%s][%s]: %v", section, param, r))
		}
...
func isProjectExist(ifConfig *InsightFinderConfig) bool {
...
func createProject(ifConfig *InsightFinderConfig) {
...
func createClient(ifConfig *InsightFinderConfig) *resty.Client {
	client := resty.New()
...
func GetInsightFinderConfig(p *configparser.ConfigParser) *InsightFinderConfig {
...
func CheckProject(ifConfig *InsightFinderConfig) {
...
func SendMetricData(ifConfig *InsightFinderConfig, metricData *[]DataMessage) {
}
